        ...
        <>
            ...
            >
                <div className="grid grid-cols-3 items-center gap-2 py-10 lg:grid-cols-3">
                    ...
                    <div className="lg:hidden flex text-5xl font-londrina lg:col-start-2 justify-center">
                        Chromafit
                    </div>
                ...
                <nav className="hidden lg:flex justify-center items-center font-montserrat text-sm -mt-5">
                    <Link
                        href="#"
                        className={`rounded-md px-3 py-2 ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] ${
                            scrollY > 10 ? "text-black" : "text-white"
            ...
            ></div>
            <div
                className={`fixed inset-y-0 left-0 bg-white z-50 transform transition-transform duration-300 ${
            ...
            >
                ...
                <nav className="flex flex-col p-4 space-y-4 font-montserrat text-sm">
                    <Link
                        href="#"
                        className={`rounded-md px-3 py-2 ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] ${
                            scrollY > 10 ? "text-black" : "text-white"
